        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`transition-all duration-1000 delay-300 ${
            ...
            <div className="relative mb-8">
              <div className="relative w-80 h-80 mx-auto rounded-3xl overflow-hidden backdrop-blur-2xl border border-white/[0.2] shadow-3xl group">
                {/* Glow Effect */}
                <div className="absolute -inset-0.5 bg-gradient-to-r from-emerald-500 via-blue-500 to-cyan-500 rounded-3xl blur opacity-30 group-hover:opacity-50 transition duration-500"></div>
                
                {/* Image Container */}
                <div className="relative w-full h-full bg-gradient-to-br from-white/[0.15] to-white/[0.05] rounded-3xl overflow-hidden">
                  <img 
                    src={TofazzalImage} 
                    alt="Dr. Tofazzal Hossain Bhuiyan - CEO & Healthcare Leader"
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="backdrop-blur-xl bg-white/10 rounded-2xl p-4 border border-white/20">
                      <p className="text-white font-bold text-lg mb-1">Dr. Tofazzal Hossain</p>
                      <p className="text-emerald-300 font-semibold text-sm">CEO • Healthcare Leader</p>
                      <p className="text-white/70 text-xs mt-1">Servier Operations Bangladesh</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -top-2 -left-2 w-4 h-4 bg-blue-400/60 rounded-full animate-pulse"></div>
              <div className="absolute -bottom-2 -right-2 w-3 h-3 bg-emerald-400/60 rounded-full animate-pulse delay-1000"></div>
            </div>
